...
action="${path}/pjController_servlet/insertpage.do" enctype="multipart/form-data">
<table border="1" width="1200px">
  ...
  <tr>
    ...
    <td style="text-align: left;"><input name="subject" id="subject" size="60"> </td>
  </tr>
  <tr>
    <td>Content </td>
    <td style="text-align: left;"><textarea rows="5" cols="60" name="content" id="content">
    </textarea> </td>
  </tr>
  <tr>
    <td>Photo </td>
  ...
  <tr>
    ...
    <input type="button" value="Leave A Review" id="btnSave">
  </tr>
</table>
</form>
</div>
