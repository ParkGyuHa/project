...
<head>
  ...
  <!-- 
	...
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="Project/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="Project/css/bootstrap.css">
	<!-- Superfish -->
	<link rel="stylesheet" href="Project/css/superfish.css">
	<!-- Flexslider  -->
	<link rel="stylesheet" href="Project/css/flexslider.css">
	...
	<body>
		...
		<header id="fh5co-header" role="banner">
			<div class="container text-center">
				<div id="header">
					<h6><a style="text-decoration: none;" href="#">D P M</a></h6>	
				</div>
				<nav>
					<ul>
						<li><a href="#">Best</a></li>
	...
	<!-- masonry -->
	<script src="Project/js/jquery.masonry.min.js"></script>
	<!-- MAIN JS -->
